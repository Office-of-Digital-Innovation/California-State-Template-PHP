                            ...
                            <div class="group">
                                ...
                                <div class="half">
                                    ...
                                    <ul class="list-standout">
                                        ...
                                        <li><strong>sample</strong> – The &ldquo;sample&rdquo; folder contains various HTML files that provide example code and  individual component documentation for the State Template.</li>
