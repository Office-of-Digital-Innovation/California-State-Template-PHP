...
<body class="primary">
    ...
    <div class="search-results-container">
		 <?php
	     include_once("ssi/search-results.php");
	     ?>	
    </div>

    <!-- Ask Bar -->
		 <?php
	     include_once("ssi/ask-bar.php");
	     ?>	
    ...
    <!-- Include for optional slideshow banner -->
		 <?php
	     include_once("ssi/header-single-banner.php");
	     ?>	
    ...
    <div id="main-content" class="main-content">
        <main class="main-primary">
	     ...
	     ?>	
         <?php
	     include_once("ssi/section-open-data.php");
	     ?>	
         <?php
	     include_once("ssi/section-green-buildings.php");
	     ?>	

		 <?php
	     include_once("ssi/section-green-stats.php");
	     ?>	
         <?php
	     include_once("ssi/section-mobile-gallery.php");
	     ?>	

		 <?php
	     include_once("ssi/section-footer2.php");
	     ?>	
         <?php
	     include_once("ssi/head-css-js.php");
	     ?>	
