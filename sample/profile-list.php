            ...
            <div class="tab-group">
                ...
                <div class="tab-content responsive">
                    <div class="tab-pane active" id="html">
                        <textarea id="sample-news-list" class="form-control" rows="10" cols="80"><?php include("../sample/modules/profile-list.php");?></textarea>
                    </div>
                    <div class="tab-pane" id="microdata">
                        <textarea id="sample-news-list" class="form-control" rows="10" cols="80"><?php include_once("../sample/modules/profile-list-schema.php");?></textarea>
                    </div>
                </div>
            </div>
