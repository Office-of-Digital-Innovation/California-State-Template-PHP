...
<div id="main-content" class="main-content">
    <div class="wrapper">
        <main class="main-primary">
            ...
            <?php include_once("../sample/modules/gallery.php");?>            
        ...
        <div class="main-secondary">
            ...
            <div class="panel panel-standout">
                ...
                <div class="panel-body">
                    <?php include_once("../sample/modules/gallery-small.php");?>                </div>
            </div>
            ...
            <div class="panel panel-standout">
                ...
                <div class="panel-body">
                    <?php include_once("../sample/modules/carousel-gallery.php");?>                </div>
            </div>
