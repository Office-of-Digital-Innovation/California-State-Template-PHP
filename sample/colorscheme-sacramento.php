...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Sacramento Color Scheme</title>
    ...
    <div id="main-content" class="main-content">
        ...
        <main class="main-primary">
            <div class="section">
                ...
                <div class="container">
                    <h1>Sacramento Theme</h1>
                    <h2>Theme Main Colors</h2>

                  <div class="group m-b-lg">
                    <div class="quarter">
                      <div class="outer">
                        <div class="shadow" style="border:1px solid #6892be;background-color:#79A9DB;">
                          <div class="color" style="background-color:#79A9DB;"></div>
                        </div>
                      </div>
                      <div class="caption">
                        <h4>
                          .color-highlight<br />@color-p1
                        </h4>HEX: #79A9DB<br>RGB: 121,169,219</div>
                    </div>
                    <div class="quarter">
                      <div class="outer">
                        <div class="shadow" style="border:1px solid #0e263e;background-color:#153554;">
                          <div class="color" style="background-color:#153554;"></div>
                        </div>
                      </div>
                      <div class="caption">
                        <h4>
                          .color-primary<br />@color-p2
                        </h4>HEX: #153554<br />RGB: 21,53,84
                      </div>
                    </div>
                    <div class="quarter">
                      <div class="outer">
                        <div class="shadow" style="border:1px solid #580000;background-color:#730000;">
                          <div class="color" style="background-color:#730000;"></div>
                        </div>
                      </div>
                      <div class="caption">
                        <h4>
                          .color-standout<br />@color-p3
                        </h4>HEX: #730000<br />RGB: 115,0,0
                      </div>
                    </div>
                    <div class="quarter">
                      <div class="outer">
                        <div class="shadow" style="border:1px solid #BBBBBB;background-color:#DADADA;">
                          <div class="color" style="background-color:#e1ecf7;"></div>
                        </div>
                      </div>
                      <div class="caption">
                        <h4>
                          .color-s1<br />@color-s1
                        </h4>HEX: #e1ecf7<br />RGB: 225,236,247
                      </div>
                    </div>
                  </div>
