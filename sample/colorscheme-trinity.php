...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Trinity Color Scheme</title>
            ...
            <div class="section">
                ...
                <div class="container">
                    ...
                    <div class="group m-b-lg">
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #987f61;background-color:#af9069;">
                                    <div class="color" style="background-color:#c19e73;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-highlight<br />@color-p1</h4>HEX: #c19e73<br>RGB: 193,158,115</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #304651;background-color:#375767;">
                                    <div class="color" style="background-color:#446a7c;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #446a7c<br />RGB: 68,106,124</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #101112;background-color:#161a1c;">
                                    <div class="color" style="background-color:#21272a;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-standout<br />@color-p3</h4>HEX: #21272a<br />RGB: 33,39,42</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #dfd8d8;background-color:#eeeaea;">
                                    <div class="color" style="background-color:#f9f8f8;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-s1<br />@color-s1</h4>HEX: #f9f8f8<br />RGB: 249,248,248</div>
                        </div>
                    </div>
