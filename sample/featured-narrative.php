         ...
         <h1>Featured Narrative</h1>
            ...
            <div class="group">
                <article class="half">
                    ...
                    <?php include("../sample/modules/featured-narrative.php"); ?>
                    <p>Etiam porta sem malesuada magna mollis euismod. Aenean lacinia bibendum nulla sed consectetur. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                </article>
                 <div class="half">
