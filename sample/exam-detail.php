        ...
        <main class="main-primary">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <?php include_once("../sample/modules/exam-detail.php");?>                </div>
                 <div class="half">
                    <h2>Source Code:</h2>
                    ...
                    <div class="tab-group">
                        ...
                        <div class="tab-content responsive">
                            <div class="tab-pane active" id="html">
                                 <textarea class="form-control" rows="10" cols="80"><<?php include_once("../sample/modules/exam-detail.php");?></textarea>
                            </div>
                            <div class="tab-pane" id="microdata">
                                <p class="alert alert-info">NOTE: This module makes use of a <code>datetime</code> property set in the <strong>ISO 8601</strong> format. Be sure to set the time correctly.</p>
                                 <textarea class="form-control" rows="10" cols="80"><<?php include_once("../sample/modules/exam-detail-schema.php");?></textarea>
                            </div>
                        </div>
                    </div>
