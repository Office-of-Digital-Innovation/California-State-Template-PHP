...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Orange County Color Scheme</title>
    ...
    <div id="main-content" class="main-content">
        ...
        <main class="main-primary">
            <div class="section">
                ...
                <div class="container">
                    <h1>Orange County Theme</h1>
                    <h2>Theme Main Colors</h2>

                    <div class="group m-b-lg">
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #c18f36;background-color:#e59c1a;">
                                    <div class="color" style="background-color:#fbad23;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-highlight<br />@color-p1</h4>HEX: #fbad23<br>RGB: 251,173,35</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #6c491f;background-color:#824c0b;">
                                    <div class="color" style="background-color:#A15801;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #A15801<br />RGB: 161,88,1</div>
                        </div>

                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #26201a;background-color:#372b1c;">
                                    <div class="color" style="background-color:#483723;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-standout<br />@color-p3</h4>HEX: #483723<br />RGB: 50,58,69</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #c0bcb2;background-color:#e8e4da;">
                                    <div class="color" style="background-color:#f1ede4;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-s1<br />@color-s1</h4>HEX: #f1ede4<br />RGB: 225,242,247</div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-understated">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                <span class="label label-info">Note:</span> <span class="font-size-sm"> Before changing your colors make sure that your custom theme colors have sufficient color cotrast ratios.</span>
                            </p>
                        </div>
                    </div>
