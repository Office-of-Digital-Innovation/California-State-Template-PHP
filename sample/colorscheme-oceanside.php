...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Oceanside Color Scheme</title>
                ...
                <div class="container">
                    ...
                    <div class="group m-b-lg">
                        <div class="quarter">
                            ...
                            <div class="caption"><h4>.color-highlight<br />@color-p1</h4>HEX: #FDB81E<br>RGB: 253,184,30</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                            ...
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #046B99<br />RGB: 4,107,153</div>
                        </div>
                        ...
                        <div class="quarter">
                            ...
                            <div class="caption"><h4>.color-standout<br />@color-p3</h4>HEX: #323A45<br />RGB: 50,58,69</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                            ...
                            <div class="caption"><h4>.color-s1<br />@color-s1</h4>HEX: #E1F2F7<br />RGB: 225,242,247</div>
                        </div>
                    </div>
