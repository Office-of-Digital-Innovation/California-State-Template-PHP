            ...
            <div class="tab-group">
                ...
                <div class="tab-content responsive">
                    <div class="tab-pane active" id="html">
                         <textarea class="form-control" rows="10" cols="80"><?php include("../sample/modules/publications.php");?></textarea>
                    </div>
                    <div class="tab-pane" id="microdata">
                         <textarea class="form-control" rows="10" cols="80"><?php include_once("../sample/modules/publications-schema.php");?></textarea>
                    </div>
                </div>
            </div>
