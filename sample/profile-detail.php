...
<div id="main-content" class="main-content">
    <div class="wrapper">
        <main class="main-primary">
            ...
            <h2>Example:</h2>
            <?php include("../sample/modules/profile-detail.php");?>            <hr>
            ...
            <div class="tab-group">
                ...
                <div class="tab-content responsive">
                    <div class="tab-pane active" id="html">
                        <textarea id="sample-news-list" class="form-control" rows="10" cols="80"><?php include("../sample/modules/profile-detail.php");?></textarea>
                    </div>
                    <div class="tab-pane" id="microdata">
                        <textarea id="sample-news-list" class="form-control" rows="10" cols="80"><?php include_once("../sample/modules/profile-detail-schema.php");?></textarea>
                    </div>
                </div>
            </div>
