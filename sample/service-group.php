    ...
    <div class="wrapper">
        <main class="main-primary">
            ...
            <div class="group">
                <div class="full">
                    <h2>Service Tiles</h2>
                    <?php include_once("../sample/modules/service-tile.php");?>                </div>
            </div>
            <div class="group">
                <div class="full">
                    <h2><label for="sample-list-a">Source Code:</label></h2>
                    <textarea id="sample-list-a" class="form-control" rows="10" cols="80"><?php include_once("../sample/modules/service-tile.php");?></textarea>
                </div>
            </div>
        </main>
    </div>
