        ...
        <main class="main-primary">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <h2>Example:</h2>
                    <?php include("../sample/modules/news-detail.php"); ?>
                </div>
                <div class="half">
                    <h2>Source Code:</h2>
                    <div class="tab-group">
                    ...
                    <div class="tab-content responsive">
                        <div class="tab-pane active" id="html">
                          <textarea aria-label="HTML Markup" id="sample-news-detail" class="form-control" rows="10" cols="80"><?php include("../sample/modules/news-detail.php"); ?></textarea>
                        </div>
                        <div class="tab-pane" id="microdata">
                          ...
                          <textarea aria-label="Microdata" id="sample-news-detail-microdata" class="form-control" rows="10" cols="80"><?php include("../sample/modules/news-detail-schema.php"); ?></textarea>
                        </div>
                    </div>
                </div>
