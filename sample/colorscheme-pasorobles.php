...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Paso Robles Color Scheme</title>
    ...
    <div id="main-content" class="main-content">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Paso Robles</li>
            </ol>
        </div>
            ...
            <div class="section">
                ...
                <div class="container">
                    ...
                    <div class="group m-b-lg">
                        ...
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #551212;background-color:#7e0101;">
                                    <div class="color" style="background-color:#9a0000;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #9a0000<br />RGB: 154,0,0</div>
                        </div>

                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #101010;background-color:#202020;">
                                    <div class="color" style="background-color:#313131;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-standout<br />@color-p3</h4>HEX: #313131<br />RGB: 49,49,49</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #d1cdcd;background-color:#e9e8e8;">
                                    <div class="color" style="background-color:#f5f5f5;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-s1<br />@color-s1</h4>HEX: #f5f5f5<br />RGB: 245,245,245</div>
                        </div>
                    </div>
