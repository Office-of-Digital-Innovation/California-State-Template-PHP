        ...
        <main class="main-primary">
            ...
            <div class="group">
                <div class="half">
                     ...
                     <?php include_once("../sample/modules/buttons.php");?>                </div>
                 <div class="half">
            ...
            <div class="group">
                <div class="half">
                     ...
                     <?php include_once("../sample/modules/buttons-active.php");?>                </div>
                 <div class="half">
            ...
            <div class="group">
                <div class="half">
                     ...
                     <?php include_once("../sample/modules/buttons-disabled.php");?>                </div>
                 <div class="half">
