        ...
        <main class="main-primary">
            ...
            <div class="group">
                <div class="two-thirds">
                    <?php include("../sample/modules/course-detail-panel.php");?>                </div>
                 <div class="third">
                    <h2>Source Code:</h2>
                    ...
                    <div class="tab-group">
                        ...
                        <div class="tab-content responsive">
                            ...
                            <div class="tab-pane" id="microdata">
                                 <textarea class="form-control" rows="10" cols="80"><?php include_once("../sample/modules/course-detail-panel-schema.php");?></textarea>
                            </div>
                        </div>
                    </div>
