...
<div id="main-content" class="main-content">
    <div class="wrapper">
        <main class="main-primary">
            ...
            <h1>Event List</h1>
            <p>An event list contains a repeating group of event items. To begin, wrap this module in a <code>&lt;section class="event-list"&gt;</code>. Then use <code>&lt;article class="event-item"&gt;</code> to group each intividual event together.</p>
            ...
            <div class="tab-group">
                ...
                <div class="tab-content responsive">
                    <div class="tab-pane active" id="html">
                        <textarea class="form-control" id="event-list" rows="10" cols="80"><?php include ("../sample/modules/event-list.php");?></textarea>
                    </div>
...
?>            
            ...
            <div class="tab-group">
                ...
                <div class="tab-content responsive">
                    <div class="tab-pane active" id="thumbhtml">
                         <textarea class="form-control" rows="10" cols="80"><?php include ("/modules/event-list-thumbnail.php");?></textarea>
                    </div>
                    <div class="tab-pane" id="thumbmicrodata">
                        <p class="alert alert-info">NOTE: This module makes use of a <code>datetime</code> property set in the <strong>ISO 8601</strong> format. Be sure to set the time correctly for each event-item.</p>
                         <textarea class="form-control" rows="10" cols="80"><?php include ("/modules/event-list-thumbnail-schema.php");?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-overstated photo-left">
                ...
                <div class="panel-body">
                    <?php include ("../sample/modules/event-list.php");?>                    <div class="photo" style="background-image: url('/sample/images/sample-nav-image.jpg');"></div>
                </div>
            </div>
        ...
        <div class="main-secondary">
            ...
            <div class="panel panel-standout highlight">
                ...
                <div class="panel-body">
                    <?php include ("../sample/modules/event-list.php");?>                </div>
            </div>
        </div>
    </div>
</div>
