...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Sierra Color Scheme</title>
            ...
            <div class="section">
                ...
                <div class="container">
                    ...
                    <div class="group m-b-lg">
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #c58f2f;background-color:#e7a126;">
                        ...
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #284139;background-color:#355d50;">
                                    <div class="color" style="background-color:#447766;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #447766<br />RGB: 68,119,102</div>
                        </div>

                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #122a2a;background-color:#143939;">
                                    <div class="color" style="background-color:#194949;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-standout<br />@color-p3</h4>HEX: #194949<br />RGB: 25,73,73</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #ceded8;background-color:#dbece6;">
                                    <div class="color" style="background-color:#effaf6;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-s1<br />@color-s1</h4>HEX: #effaf6<br />RGB: 239,250,246</div>
                        </div>
                    </div>
