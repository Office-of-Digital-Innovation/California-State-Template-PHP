        ...
        <main class="main-primary">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <h2>Example:</h2>
                    <?php include("../sample/modules/table.php"); ?>
                </div>
                 <div class="half">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <h2>Example:</h2>
                    <?php include("../sample/modules/table-default.php"); ?>
                </div>
                 <div class="half">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <h2>Example:</h2>
                    <?php include("../sample/modules/table-striped.php"); ?>
                </div>
                 <div class="half">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <h2>Example:</h2>
                    <?php include("../sample/modules/table-bordered.php"); ?>
                </div>
                 <div class="half">
            ...
            <div class="group">
                <div class="half">
                    ...
                    <h2>Example:</h2>
                    <?php include("../sample/modules/table-responsive.php"); ?>
                </div>
                 <div class="half">
