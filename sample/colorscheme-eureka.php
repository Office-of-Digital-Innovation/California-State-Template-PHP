...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Eureka Color Scheme</title>
            ...
            <div class="section">
                ...
                <div class="container">
                    ...
                    <div class="group m-b-lg">
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #ad917c;background-color:#c8a58b;">
                                    <div class="color" style="background-color:#D9B295;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-highlight<br />@color-p1</h4>HEX: #D9B295<br>RGB: 217,178,149</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #222829;background-color:#313b3d;">
                                    <div class="color" style="background-color:#3E4B4D;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #3E4B4D<br />RGB: 62,75,77</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #21272A;background-color:#21272A;">
