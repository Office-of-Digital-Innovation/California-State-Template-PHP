...
<div id="main-content" class="main-content">
    <div class="section">
        <main class="main-primary">
            ...
            <?php include("../sample/modules/location-full.php"); ?>
            <hr>
            <h2>Source Code:</h2>
            ...
            <div class="tab-group">
                ...
                <div class="tab-content responsive">
                    <div class="tab-pane active" id="html">
                      <textarea aria-label="HTML Markup" class="form-control" rows="10" cols="80"><?php include("../sample/modules/location-full.php"); ?></textarea>
                    </div>
                    <div class="tab-pane" id="microdata">
                      <textarea aria-label="Microdata" class="form-control" rows="10" cols="80"><?php include("../sample/modules/location-full-schema.php"); ?></textarea>
                    </div>
                </div>
            </div>
        </main>
