...
<div tabindex="0" class="service-tile" data-tile-id="2" style="background:url(/sample/images/service-tiles/redwoods.jpg); background-size: cover;">
    <div class="teaser">
        <h4 class="title">Find a Park</h4>
    </div>
</div>

<div tabindex="0" class="service-tile" data-tile-id="3" style="background:url(/sample/images/gallery/sierra-big.jpg); background-size: cover;">
    <div class="teaser">
        <h4 class="title">Seperate Teaser Titles</h4>
    </div>
</div>

<div tabindex="0" class="service-tile" data-tile-id="4">
    <span class="icon-fallback ca-gov-icon-logo"></span>
    <div class="teaser">
        <h4 class="title">Top Trending Title</h4>
    </div>
</div>
<!-- END TILES -->

<!-- BEGIN PANELS -->
<div class="service-tile-panel" data-tile-id="fakeid" >
...
<div class="service-tile-panel" data-tile-id="2" >
        <div class="section section-default">
