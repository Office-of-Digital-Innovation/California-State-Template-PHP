...
<nav id="navigation" class="main-navigation megadropdown original">
    <ul id="nav_list" class="top-level-nav">
        ...
        <li class="nav-item active">
            ...
            <span class="mobile-control toggle-sub-nav closed"><span class="ca-gov-icon-menu-toggle-open" aria-hidden="true"></span><span class="sr-only">Sub Menu Toggle</span></span><div class="sub-nav">
        ...
        <li class="nav-item">
            <a href="/about.php"> class="first-level-link has-sub"><span class="ca-gov-icon-info-bubble" aria-hidden="true"></span>About</a>
            <span class="mobile-control toggle-sub-nav closed"><span class="ca-gov-icon-menu-toggle-open" aria-hidden="true"></span><span class="sr-only">Sub Menu Toggle</span></span><div class="sub-nav">
                <ul class="second-level-nav">
                    <li>
        ...
        <li class="nav-item">
            <a href="/structure.php"> class="first-level-link has-sub"><span class="ca-gov-icon-flowchart" aria-hidden="true"></span>Structure</a>
            <span class="mobile-control toggle-sub-nav closed"><span class="ca-gov-icon-menu-toggle-open" aria-hidden="true"></span><span class="sr-only">Sub Menu Toggle</span></span>
        ...
        <li class="nav-item">
            <a href="https://github.com/Office-of-Digital-Innovation" target="_blank" class="first-level-link has-sub"><span class="ca-gov-icon-download" aria-hidden="true"></span>Download</a>
            <span class="mobile-control toggle-sub-nav closed"><span class="ca-gov-icon-menu-toggle-open" aria-hidden="true"></span><span class="sr-only">Sub Menu Toggle</span></span>
        ...
        <li class="nav-item">
            <a href="/contact.php"> class="first-level-link"><span class="ca-gov-icon-lightbulb" aria-hidden="true"></span>Contact Us</a>
            <span class="mobile-control toggle-sub-nav closed"><span class="ca-gov-icon-menu-toggle-open" aria-hidden="true"></span><span class="sr-only">Sub Menu Toggle</span></span>
