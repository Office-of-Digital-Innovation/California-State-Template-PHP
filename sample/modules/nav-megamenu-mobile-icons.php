...
<!-- Add more mobile controls here. These will be in the top portion of the expanded menu when viewed on a mobile device  -->
     <div class="mobile-controls">
            <span class="mobile-control cagov-logo">
                <span class="ca-gov-icon-logo" aria-hidden="false"></span><span class="sr-only">CA logo<</span>
            </span>
            <span class="mobile-control contact-link">
                 <span class="ca-gov-icon-chat" aria-hidden="true"></span><span class="sr-only">Contact</span>
            </span>
            <span class="mobile-control sample-link">
                <span class="ca-gov-icon-capitol" aria-hidden="true"></span><span class="sr-only">Capitol Website</span>
            </span>
    ...
    <ul id="nav_list" class="top-level-nav">
        ...
        <li class="nav-item">
            <a href="/about.php"> class="first-level-link"><span class="ca-gov-icon-info-bubble" aria-hidden="true"></span>About</a>
            <div class="sub-nav">
        ...
        <!-- LEFT ALIGNED IMAGE -->
        <li class="nav-item">
            <a href="/structure.php"> class="first-level-link"><span class="ca-gov-icon-flowchart" aria-hidden="true"></span>Structure</a>
            <div class="sub-nav">
