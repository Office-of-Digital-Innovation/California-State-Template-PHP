                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <textarea id="sample-news-blocks" class="form-control" rows="10" cols="80"><?php include("../sample/modules/icon-blocks.php"); ?></textarea>
                                    </div>
                        ...
                        <div class="modal fade" id="icon-image-blocks" role="dialog">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <label for="sample-news-blocks">Source Code:</label>
                                        <textarea id="sample-news-blocks" class="form-control" rows="10" cols="80"><?php include("../sample/modules/icon-image-blocks.php"); ?></textarea>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                    </div>
