            ...
            <div class="section">
                ...
                <div class="container">
                    ...
                    <div class="group m-b-lg">
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #d5b035;background-color:#efc12a;">
                                    <div class="color" style="background-color:#ffce2b;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-highlight<br />@color-p1</h4>HEX: #ffce2b<br>RGB: 255,206,43</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #363635;background-color:#474644;">
                                    <div class="color" style="background-color:#545351;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-primary<br />@color-p2</h4>HEX: #545351<br />RGB: 84,84,84</div>
                        </div>

                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #0a0a0a;background-color:#0a0a0a;">
                                    <div class="color" style="background-color:#191919;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-standout<br />@color-p3</h4>HEX: #191919<br />RGB: 25,25,25</div>
                        </div>
                        <div class="quarter">
                            <div class="outer">
                                <div class="shadow" style="border:1px solid #ceccc4;background-color:#e7e6e1;">
                                    <div class="color" style="background-color:#f4f3ef;"></div>
                                </div>
                            </div>
                            <div class="caption"><h4>.color-s1<br />@color-s1</h4>HEX: #f4f3ef<br />RGB: 244,243,239</div>
                        </div>
                    </div>
